...
{
  internal sealed class MorrisMeasuresViewModel : IMorrisMeasuresViewModel
  {
    ...
    public MorrisMeasureType MorrisMeasureType { get => MorrisMeasureType.MuStar; set => throw new NotImplementedException(); }
