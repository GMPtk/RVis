...
namespace RVis.Model.Test
{
  ...
  public class UnitTestNormalDistribution
  {
    ...
    [TestMethod()]
    public void TestNormalCumulativeDistributionAtBounds()
    {
      // arrange
      var subject = new NormalDistribution(0.5, 1d, 0.3, 0.7);
      var expectedLowerP = GetNumData("pnorm(0.3, 0.5, 1.0)")[0].Data[0];
      var expectedUpperP = GetNumData("pnorm(0.7, 0.5, 1.0)")[0].Data[0];
...
#if !IS_PIPELINES_BUILD
    [TestMethod()]
    public void TestNormalGetDensities()
    {
      // arrange
