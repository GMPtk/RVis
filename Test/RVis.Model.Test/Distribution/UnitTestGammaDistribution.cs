...
namespace RVis.Model.Test
{
  ...
  public class UnitTestGammaDistribution
  {
    ...
    [TestMethod()]
    public void TestGammaCumulativeDistributionAtBounds()
    {
      // arrange
      var subject = new GammaDistribution(1d, 1d, 0.3, 0.7);
      var expectedLowerP = GetNumData("pgamma(0.3, 1.0)")[0].Data[0];
      var expectedUpperP = GetNumData("pgamma(0.7, 1.0)")[0].Data[0];
...
#if !IS_PIPELINES_BUILD
    [TestMethod()]
    public void TestGammaGetDensities()
    {
      // arrange
